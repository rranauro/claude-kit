...
## Why `pr-review-on-create` fires reliably here

A hook only fires in the session that registered it — see
[ADR 0004](adr/0004-restore-the-pr-review-hook.md) for why that isn't a
coverage gap here.
